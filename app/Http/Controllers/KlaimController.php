...
class KlaimController extends Controller
{
    ...
    {
        try {
            // Coba ambil data klaim berserta relasinya
            ...
            // Jika tabel/relasi belum dibuat di database atau model, kembalikan array kosong 
            // agar frontend tidak crash ("Failed to fetch")
    ...
    public function status($id, Request $request)
    {
        try {
            ...
            return response()->json([
             ...
             return response()->json(['message' => 'Klaim tidak ditemukan atau terjadi kesalahan server'], 404);
        }
    }

    // Admin: lihat klaim pending (UNTUK DASHBOARD)
